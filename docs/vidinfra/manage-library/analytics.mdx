---
title: 'Staistics Dashboard'
description: 'Monitor views, watch time, and delivery stats to understand how your videos perform.'
icon: 'chart-area'
...
This dashboard shows how your videos are being delivered across the network. Each metric helps you understand usage trends, delivery performance, and caching efficiency over a selected time range.
